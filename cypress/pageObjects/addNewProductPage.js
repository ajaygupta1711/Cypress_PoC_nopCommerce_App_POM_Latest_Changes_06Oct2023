class addNewProductPage {
    ...
    elements = {
        ...
        clickOnProductInfoPlusIcon: () => cy.xpath("(//i[@class='fa toggle-icon fa-plus'])[1]"),
        ...
        clickOnPricesPlusIcon: () => cy.xpath("(//i[@class='fa toggle-icon fa-plus'])[2]"),
    ...
    clickonProductInfoPlus(){
        this.elements.clickOnProductInfoPlusIcon().click();
    }
    ...
    clickonPricesPlus() {
        this.elements.clickOnPricesPlusIcon().click();
    }
